...
chunkedStream.prototype = Object.create(stream.Readable.prototype, { constructor: { value: chunkedStream } } );


function chunkedStream(input, encoding, hwm) {
...
chunkedStream.prototype.version = '0.1.0';

chunkedStream.prototype._start = function() {
	var self = this;
	if (this.type === 'buffer') {
...
chunkedStream.prototype._read = function(size) {
	// console.log('--> READ');
	var self = this;
